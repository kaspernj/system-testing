...
- Reject non-positive notification assertion timeouts before starting a WebDriver lookup.
- Restore late implicit-timeout changes only while they still own driver state, and invalidate sessions with abandoned WebDriver commands.
